-- Filter out headers that match the hardcoded defaults (User-Agent: yakumo, Accept: */*),
...
SET headers = (
    ...
    WHERE NOT (
        (LOWER(json_extract(value, '$.name')) = 'user-agent' AND json_extract(value, '$.value') = 'yakumo')
