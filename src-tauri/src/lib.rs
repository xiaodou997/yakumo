...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            yaku_commands::cmd_yaku_cookie_jar_list,
            yaku_commands::cmd_yaku_cookie_jar_create,
            yaku_commands::cmd_yaku_cookie_jar_delete,
            yaku_commands::cmd_yaku_cookie_list,
            yaku_commands::cmd_yaku_cookie_delete,
            yaku_commands::cmd_yaku_cookie_jar_clear,
            yaku_commands::cmd_yaku_secret_audit,
            yaku_commands::cmd_yaku_secret_delete,
            yaku_commands::cmd_yaku_secret_orphans_delete,
            yaku_commands::cmd_yaku_grpc_services,
